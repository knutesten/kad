...
public class CategoryDaoImplTest {
    ...
    private static final Topic topic3 = new Topic(3, "title3", mock(User.class) , new Date(20));
    ...
    private static final Category kameler = new Category(3, "Kameler", topic3);
    ...
    public static void beforeClass() throws Exception {
        ...
        when(topicDao.getTopicById(3)).thenReturn(topic3);
